...
;(function ( $, window, document, undefined ) {
  'use strict';
    ...
    // Font field
    $( '.cs_font_field' ).each(function() {
        var parentName = $( this ).attr( 'data-id' );
        var preview = $( this ).find( '#preview-' + parentName );
        var fontColor = $( this ).find( '.wp-picker-input-wrap input' );
        var fontSize = $( this ).find( '.font-size input' );
        var lineHeight = $( this ).find( '.line-height input' );
        var fontFamily = $( this ).find( '.cs-typo-family' );
        var fontWeight = $( this ).find( '.chosen.cs-typo-variant' );
        ...
        $( fontFamily ).add( fontWeight ).change(function() {
            loadGoogleFont( this, parentName, fontFamily, fontWeight );
        });
