...
jQuery(function(){
  var random = Math.floor(Math.random() * jQuery('.bonfire-pageloader-sentence-inner').length);
  jQuery('.bonfire-pageloader-sentence-inner').eq(random).show();    
});
